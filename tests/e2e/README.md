...
| ---------------------------- | ----- | ------------------------ |
| `LOKSYSTEM_E2E_TEST`            | `1`   | App recognizes test mode |
| `LOKSYSTEM_DISABLE_AUTO_UPDATE` | `1`   | No update checks         |
| `LOKSYSTEM_DISABLE_DEVTOOLS`    | `1`   | No DevTools windows      |
| `LOKSYSTEM_CDP_PORT`            | `0`   | CDP disabled             |
...
```bash
# Clean via database
sqlite3 "~/Library/Application Support/LokSystem-Dev/loksystem/loksystem.db" \
