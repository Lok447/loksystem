...
const {
  ...
  return {
    ...
    mockConversationService: {
      createConversation: vi.fn(async () => ({ id: 'conv-created', name: 'Created Conversation', source: 'loksystem' })),
      deleteConversation: vi.fn(async () => {}),
      updateConversation: vi.fn(async () => {}),
      getConversation: vi.fn(async () => ({ id: 'conv-1', source: 'loksystem', name: 'Original Name', type: 'gemini' })),
      createWithMigration: vi.fn(async () => ({ id: 'conv-migrated', source: 'loksystem' })),
    },
    mockWorkerTaskManager: {
      getTask: vi.fn(),
