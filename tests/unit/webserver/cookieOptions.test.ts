...
const ENV_KEYS = ['LOKSYSTEM_HTTPS', 'HTTPS', 'NODE_ENV', 'SERVER_BASE_URL'] as const;
...
describe('getCookieOptions', () => {
  ...
  it('issues Secure + SameSite=None when LOKSYSTEM_HTTPS=true', () => {
    process.env.LOKSYSTEM_HTTPS = 'true';
