...
> PR：[#1991](https://github.com/iOfficeAI/LokSystem/pull/1991) (问题 1-3)
> Issue：[#1990](https://github.com/iOfficeAI/LokSystem/issues/1990)
...
JSON 文件 KV 存储，每个扩展一个文件 `~/.loksystem/extension-storage/{name}.json`：
