...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <strong>Türkçe</strong> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.loksystem.com" target="_blank">Resmi Web Sitesi</a>
</p>

<p align="center">
  <strong>💬 Topluluk:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-9.png" target="_blank">微信 (中文群)</a> | <a href="https://github.com/iOfficeAI/LokSystem" target="_blank">GitHub</a>
</p>
...
[🤔 Neden LokSystem'yi Seçmelisiniz?](#-neden-loksystem-claude-cowork-yerine) ·
...
**LokSystem sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **LokSystem (Cowork)**                                                                                                                   |
| :------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------ |
...
LokSystem tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **LokSystem kurduğunuz anda çalışır**.
...
Zaten Claude Code, Codex, Hermes Agent veya OpenClaw kullanıyorsanız, LokSystem bunları otomatik olarak algılar ve hepsiyle Cowork yapmanıza izin verir — yerleşik Agent ile birlikte.

**Desteklenen Agents:** Yerleşik Agent (sıfır kurulum) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Lok CLI (aionrs, LokSystem ile birlikte gelen Rust tabanlı arka uç servisi) • Snow CLI • Kiro • Hermes Agent • Cursor Agent ve daha fazlası
...
- **Paralel çoklu agent çalıştırma** — Leader görevleri alt görevlere bölerek paralel çalışan Teammate Agent'lara devreder; her Teammate ACP (Agent Communication Protocol, LokSystem'nin çoklu agent koordinasyon katmanı), Gemini veya Aionrs aracılığıyla kendi modelini kullanır
- **Leader orkestrasyonu** — Leader atar, izler ve sonuçları toplar; desteklenen arka uçlar: Claude Code, Codex, Hermes Agent, Gemini, Snow CLI ve Lok CLI
...
- **Desteklenen arka uçlar** — Claude Code, Codex, Gemini, Snow CLI, Lok CLI (aionrs); `mcpCapabilities.stdio` ile diğer ACP arka uçları otomatik desteklenir
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **LokSystem size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. LokSystem bulut hizmetleri ve yerel dağıtımlar dahil **20+ AI platformunu** destekler.
...
LokSystem ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
- **Üç katmanlı Beceriler** — Yerleşik beceriler (LokSystem ile birlikte gelen), özel beceriler (kendinizinkiler) ve Extension becerileri (üçüncü taraf uzantılar tarafından katkıda bulunulan); beceri göstergesi ile konuşma başına etkinleştirin/devre dışı bırakın
...
LokSystem önceden tanımlanmış yeteneklere sahip **20 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — LokSystem'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** LokSystem Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
> [Uzaktan İnternet Erişimi Öğreticisi](https://github.com/iOfficeAI/LokSystem/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Uyanık kal** — LokSystem görevler aktifken sistem uyku moduna geçmeyi otomatik olarak önler ve uyandıktan sonra kaçırılan tetikleyicileri algılar
...
> [Görüntü oluşturma modeli yapılandırma kılavuzu](https://github.com/iOfficeAI/LokSystem/wiki/LokSystem-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Neden LokSystem, Claude Cowork Yerine?
...
LokSystem **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, LokSystem tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | LokSystem                                            |
| :-------------- | :------------ | :------------------------------------------------ |
...
<details>
<summary><strong>S: LokSystem ile ne yapabilirim?</strong></summary>
C: LokSystem sizin <strong>özel Cowork çalışma alanınızdır</strong>. Yerleşik Agent klasörleri toplu olarak organize edebilir, Excel verilerini işleyebilir, belgeler oluşturabilir, web'de arama yapabilir ve görüntüler oluşturabilir. Çoklu Agent Modu ile aynı arayüz üzerinden Claude Code, Codex ve diğer güçlü CLI Agent'larından da yararlanabilirsiniz.
</details>

<details>
<summary><strong>S: Ücretsiz mi?</strong></summary>
C: LokSystem tamamen ücretsiz ve açık kaynaklıdır. Gemini'yi ücretsiz kullanmak için Google ile giriş yapabilir veya tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların LokSystem'yi Nasıl Kullandığını Görün
...
> **LokSystem hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/LokSystem) ve burada öne çıkaralım!
...
- [📖 Tam Kurulum Kılavuzu](https://github.com/iOfficeAI/LokSystem/wiki/Getting-Started) — İndirmeden yapılandırmaya kadar detaylı adımlar
- [⚙️ LLM Yapılandırma Kılavuzu](https://github.com/iOfficeAI/LokSystem/wiki/LLM-Configuration) — Çoklu platform AI model yapılandırması
- [🤖 Çoklu Agent Modu Kurulumu](https://github.com/iOfficeAI/LokSystem/wiki/ACP-Setup) — Terminal AI Agent'larını entegre edin
- [🔌 MCP Araç Yapılandırması](https://github.com/iOfficeAI/LokSystem/wiki/MCP-Configuration-Guide) — Model Context Protocol sunucu kurulumu
- [🌐 WebUI Yapılandırma Kılavuzu](https://github.com/iOfficeAI/LokSystem/wiki/WebUI-Configuration-Guide) — Tam WebUI kurulum ve yapılandırma öğreticisi

**🎯 Kullanım Senaryoları**

- [📁 Dosya Yönetimi](https://github.com/iOfficeAI/LokSystem/wiki/file-management) — Akıllı dosya organizasyonu
- [📊 Excel İşleme](https://github.com/iOfficeAI/LokSystem/wiki/excel-processing) — AI destekli veri işleme
- [🎨 Görüntü Oluşturma](https://github.com/iOfficeAI/LokSystem/wiki/LokSystem-Image-Generation-Tool-Model-Configuration-Guide) — AI görüntü oluşturma
- [📚 Daha Fazla Kullanım Senaryosu](https://github.com/iOfficeAI/LokSystem/wiki/Use-Cases-Overview)

**❓ Destek ve Yardım**

- [❓ SSS](https://github.com/iOfficeAI/LokSystem/wiki/FAQ) — Sorular ve sorun giderme
- [🔧 Yapılandırma ve Kullanım Öğreticileri](https://github.com/iOfficeAI/LokSystem/wiki/Configuration-Guides) — Tam yapılandırma dokümantasyonu
...
- [GitHub Discussions](https://github.com/iOfficeAI/LokSystem/discussions) — fikirleri paylaşın ve ipuçları alışverişi yapın
- [Sorun Bildir](https://github.com/iOfficeAI/LokSystem/issues) — hatalar ve özellik istekleri
- [Sürüm Güncellemeleri](https://github.com/iOfficeAI/LokSystem/releases) — en son sürümü alın
...
[Hata Bildir](https://github.com/iOfficeAI/LokSystem/issues) · [Özellik İste](https://github.com/iOfficeAI/LokSystem/issues)
