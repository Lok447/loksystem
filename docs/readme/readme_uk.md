<p align="center">
  <img src="../../resources/loksystem-banner-1.png" alt="LokSystem - Спільна робота з AI-агентами" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/iOfficeAI/LokSystem?style=flat-square&color=32CD32" alt="Версія">
  &nbsp;
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <strong>Українська</strong> | <a href="https://www.loksystem.com" target="_blank">Офіційний сайт</a>
</p>

<p align="center">
  <strong>💬 Спільнота:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-9.png" target="_blank">微信 (中文群)</a> | <a href="https://github.com/iOfficeAI/LokSystem" target="_blank">GitHub</a>
</p>
...
[🤔 Чому варто обрати LokSystem?](#-чому-варто-обрати-loksystem-замість-claude-cowork) ·
...
**LokSystem — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **LokSystem (Cowork)**                                                                                                        |
| :--------------------------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------------- |
...
LokSystem постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **LokSystem працює одразу після встановлення**.
...
Якщо ви вже використовуєте Claude Code, Codex, Hermes Agent або OpenClaw, LokSystem автоматично виявить їх і дозволить працювати з усіма ними разом із вбудованим агентом.

**Підтримувані агенти:** Вбудований агент • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Lok CLI (aionrs, Rust-бекенд-сервіс у складі LokSystem) • Snow CLI • Kiro • Hermes Agent • Cursor Agent та інші
...
- **Паралельне виконання кількох агентів** — Leader ділить завдання на підзадачі і делегує паралельно працюючим Teammate-агентам; кожен Teammate використовує свою модель через ACP (Agent Communication Protocol, шар координації мульти-агентності LokSystem), Gemini або Aionrs
- **Оркестрація Leader** — Leader призначає, відстежує та агрегує результати; підтримувані бекенди: Claude Code, Codex, Hermes Agent, Gemini, Snow CLI, Lok CLI
...
- **Підтримувані бекенди** — Claude Code, Codex, Gemini, Snow CLI, Lok CLI (aionrs); інші ACP-бекенди з `mcpCapabilities.stdio` підтримуються автоматично
...
Інші додатки дають лише вікно чату. **LokSystem дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. LokSystem підтримує **20+ AI-платформ**.
...
- **Трирівневі навички** — вбудовані навички (поставляються з LokSystem), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
...
**Навички**: навички з трьох джерел — вбудовані (поставляються з LokSystem), власні (ваші особисті) та Extension (через Extension SDK). Вбудовані: `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` та інші.
...
- **Режим без сну** — LokSystem автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
<p align="center">
  <img src="../../resources/loksystem sort file 2.gif" alt="Керування файлами" width="800">
</p>

---

## 🤔 Чому варто обрати LokSystem замість Claude Cowork?

LokSystem — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, LokSystem — це версія з підтримкою всіх моделей та платформ.
...
- [GitHub Discussions](https://github.com/iOfficeAI/LokSystem/discussions) — діліться ідеями
- [Повідомити про проблему](https://github.com/iOfficeAI/LokSystem/issues) — баги та запити функцій
