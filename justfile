# LokSystem Development Justfile
# Usage: just <recipe>
...
preflight:
    ...
    $failed = $false; \
    Write-Host "=========================================="; \
    Write-Host "  LokSystem Build Preflight Check"; \
    Write-Host "=========================================="; \
    Write-Host ""; \
...
info:
    Write-Host "LokSystem Build Environment"; \
    Write-Host "========================"; \
...
build-win: preflight
    ...
    Get-Process -Name "LokSystem","AionUI","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue; \
