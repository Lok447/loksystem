...
function getLogFilePath(): string {
  ...
  // Dev mode uses "LokSystem-Dev", production uses "LokSystem"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'LokSystem-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'LokSystem', `${today}.log`);
