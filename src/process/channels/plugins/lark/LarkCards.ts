...
export function createMainMenuCard(): LarkCard {
  return {
    ...
    header: {
      title: { tag: 'plain_text', content: 'LokSystem Assistant' },
      template: 'blue',
    },
    elements: [
      {
    ...
    elements: [
      {
        ...
        content: [
          '**What is pairing?**',
          'Pairing links your Lark/Feishu account with the local LokSystem application.',
...
export function createHelpCard(): LarkCard {
  return {
    config: { wide_screen_mode: true },
    header: {
      title: { tag: 'plain_text', content: '❓ LokSystem Assistant Help' },
      template: 'turquoise',
    },
    elements: [
      {
        tag: 'markdown',
        content: [
          'A remote assistant to interact with LokSystem via Lark.',
          '',
          '**Common Actions:**',
