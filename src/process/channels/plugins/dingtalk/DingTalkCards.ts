...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'LokSystem Assistant',
    text: '### LokSystem Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with LokSystem:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open LokSystem settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in LokSystem settings:',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'LokSystem Assistant Help',
    text: [
      '### LokSystem Assistant Help',
      '',
      'A remote assistant to interact with LokSystem via DingTalk.',
      '',
      '**Common Actions:**',
