...
4. PUT /v1.0/card/streaming            # Stream content (repeat)
   ...
   - isFull: true                      # Full replacement (LokSystem sends complete content each time)
...
- **`isFull: true`** is always used because LokSystem sends the complete message content on each edit (not incremental deltas)
