...
/**
 * Adapter class to convert ACP messages to LokSystem message format
 */
export class AcpAdapter {
  ...
  /**
   * Convert ACP session update to LokSystem messages
   */
  ...
  /**
   * Convert ACP session update chunk to LokSystem message
   */
  ...
  /**
   * Convert ACP thought chunk to LokSystem message
   */
  ...
  /**
   * Convert plan update to LokSystem message
   */
