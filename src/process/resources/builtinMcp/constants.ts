...
export const BUILTIN_IMAGE_GEN_NAME = 'loksystem-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['LokSystem Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
