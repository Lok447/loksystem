...
export const PROTOCOL_SCHEME = 'loksystem';

/**
 * Parse an loksystem:// URL into action and params.
 * Supports two formats:
 *   1. loksystem://add-provider?baseUrl=xxx&apiKey=xxx
 *   2. loksystem://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
