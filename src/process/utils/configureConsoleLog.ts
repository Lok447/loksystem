 ...
 *   - macOS:   ~/Library/Logs/LokSystem/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\LokSystem\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/LokSystem/logs/YYYY-MM-DD.log
 *
