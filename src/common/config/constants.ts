...
/** 临时文件时间戳分隔符 */
export const LOKSYSTEM_TIMESTAMP_SEPARATOR = '_loksystem_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const LOKSYSTEM_TIMESTAMP_REGEX = /_loksystem_\d{13}(\.\w+)?$/;
export const LOKSYSTEM_FILES_MARKER = '[[AION_FILES]]';
...
export const WEBUI_DEFAULT_PORT = (() => {
  ...
  if (process.env.LOKSYSTEM_MULTI_INSTANCE === '1') return 25810;
  return 25809;
})();
