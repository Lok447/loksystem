...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'loksystem_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'loksystem:workspace-expansion-changed';
