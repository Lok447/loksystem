export const WORKSPACE_TOGGLE_EVENT = 'loksystem-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'loksystem-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'loksystem-workspace-has-files';
